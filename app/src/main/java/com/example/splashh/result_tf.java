...
public class result_tf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.result_tf);
        ...
        wrong.setText("INCORRECT ANSWERS = " + s2);
            ...
            public void onClick(View view) {
                Intent intent = new Intent(result_tf.this, MainActivity2.class);
        ...
        Try.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(result_tf.this, truefalse.class);
                startActivity(intent);
            }
        });
